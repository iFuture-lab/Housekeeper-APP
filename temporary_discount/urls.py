...
from .views import DiscountCreateView,DiscountRetrieveUpdateDestroyView,PromotionCodeCreateView,PromotionCodeRetrieveUpdateDestroyView,PackageByRequestTypeView,PackageCreateView,PackageRetrieveUpdateDestroyView, DiscountBatchView, PackageBatchView
...
urlpatterns = [
    ...
    path('custom-packages/batch/', PackageBatchView.as_view(), name='custom-package-batch'),
